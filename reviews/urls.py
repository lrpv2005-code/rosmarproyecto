...
urlpatterns = [
    ...
    path('agregar/<str:media_type>/<int:tmdb_id>/', views.agregar_desde_tmdb, name='agregar_desde_tmdb'),
    path('agregar-catalogo/<str:media_type>/<int:tmdb_id>/', views.agregar_catalogo_personal, name='agregar_catalogo_personal'),
